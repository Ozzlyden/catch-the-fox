...
public class EnemySpawn {
	...
	public void tick() {
		...
		if(curTimeEn1 == targetTimeEnemy1) {
			...
			int xWidth = Entity.rand.nextInt(Game.WIDTH - 40);	// -40 para nao sair da tela parte de cima
			int yHeight = -40;
			
			int xxWidth = Entity.rand.nextInt(Game.WIDTH - 40);	// -40 para nao sair da tela para de baixo
			int yyHeight = Entity.rand.nextInt(Game.WIDTH - 40);
